...
import com.pouffydev.krystalsmaterialcompats.foundation.data.lang.util.Components;
import com.pouffydev.krystalsmaterialcompats.foundation.data.lang.util.LangBuilder;
import com.pouffydev.krystalsmaterialcompats.foundation.data.lang.util.LangNumberFormat;
...
public class Lang {
    ...
    public static MutableComponent translateDirect(String key, Object... args) {
        return Components.translatable(MaterialCompats.ID + "." + key, resolveBuilders(args));
    }
    ...
    public static LangBuilder builder() {
        return new LangBuilder(MaterialCompats.ID);
    }
